import {
  FrontpageFeedItem,
  FrontpageFeedItemProps,
} from './frontpage-feed-item/frontpage-feed-item';

import React from 'react';

const mockFrontpageFeedItemCollection: FrontpageFeedItemProps[] = [
  {
    title: 'Mane Bitch',
    avatarSrc:
...
export function FrontPageFeed() {
  const [posts] = React.useState<FrontpageFeedItemProps[]>(
    mockFrontpageFeedItemCollection
  );
